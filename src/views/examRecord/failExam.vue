<template>
  <div class="scroll" v-if="failScoreData.length>=0">
    <div v-if="failScoreData.length>0" class="infinite-list" style="overflow:auto">
      <div class="flex">
      ...
      <div>
        <div v-for="(item,index) in failScoreData" :key="index">
          <div class="flex">
